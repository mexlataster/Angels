<?php
	$title = Angels;
 	include 'pages/includes/topi.php';
?>
<body>
	<div class="frame">
	<?php 
			$h1 = 'Angels';
			$p = 'Do you believe in these creatures in the sky?';
			include 'pages/includes/header.php';
		 ?>
		 <?php
		 	$la1 = 'active';
		 	$l1 = 'index.php';
		 	$l2 = 'pages/heavens.php';
		 	$l3 = "pages/guardian.php";
		 	$l4 = "pages/evolution.php";
		...
		<div class="content">
			...
			<div class="article">
				<h2>Angels listen</h2>
				<img src="pics/angel3.gif"  class="img-topleft"/>
